...
const ApartmentDetails = () => {
  ...
  useEffect(() => {
    fetch(`https://rocky-shelf-02632.herokuapp.com/apartments/${_id}`)
      .then((res) => res.json())
      .then((data) => {
        setSelectedApt(data);
        setLoading(false);
  ...
  const onSubmit = (data) => {
    ...
    fetch('https://rocky-shelf-02632.herokuapp.com/addRegistration', {
      method: 'POST',
      ...
      <section className='container'>
        <div className='row'>
          ...
          <div className='col-md-7 mt-4'>
            ...
            <img className='w-100' src={selectedApt.image} alt='' />
            {/* )} */}
